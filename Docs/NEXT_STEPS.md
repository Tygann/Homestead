...
- Organized the Cards gallery into Layout, Cards, and Planned sections. Calendar, Map, Picture, Area, Person, Energy, Text, and Spacer are subdued gallery-only roadmap metadata with no persisted item cases, renderers, source routes, or add behavior; one flag can hide Planned for public release.
