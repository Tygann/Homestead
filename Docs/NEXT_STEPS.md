...
- Reworked Settings > Account around Home Assistant's Internal URL and External URL plus Homestead's Active Connection, optional Home Networks, and toolbar-driven inline Edit/Cancel/Save. The internal OAuth identity anchor is no longer exposed as a confusing third URL.
