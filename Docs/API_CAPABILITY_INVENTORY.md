...
| Expanded widgets | WidgetKit/App Intents plus OAuth/WebSocket/history/service calls | In progress | Home Screen light/switch controls, sensor/person status, numeric sensor graphs, and scene/script action widgets exist; Control Center controls and additional safe control domains remain follow-up scope. |
