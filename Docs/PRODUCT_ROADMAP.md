...
- Home dashboard with configurable entity cards, Apple Home-inspired mini accessory tiles, Home Assistant frontend-aligned summary chips/views, section headers, card sizes, card feature visibility, display names, icon overrides, direct card/header drag editing, chip reordering, and edit mode.
