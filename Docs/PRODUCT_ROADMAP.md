...
- Native sensor history detail charts and dashboard chart cards backed by Home Assistant's documented REST history API, starting with numeric `sensor.*` entities and fixed ranges.
