...
- Tightened the combined forecast hierarchy with compact flush-leading Hourly content, no redundant interval subtitles, Today labeling, a current-temperature range marker, and one retry state when all supported forecast subscriptions fail.
